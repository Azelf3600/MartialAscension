...
function drawCharacterSelectTraining() {
  ...
  FIGHTERS.forEach((fighter, index) => {
    ...
    let isSelected = (index === selectedTrainingChar);
  ...
  let selectedCol = selectedTrainingChar % cols;
  let selectedRow = Math.floor(selectedTrainingChar / cols);
